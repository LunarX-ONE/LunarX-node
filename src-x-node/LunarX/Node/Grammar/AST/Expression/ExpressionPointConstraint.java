...
public class ExpressionPointConstraint extends Expression{

	final public String _table;  
	final public String _column;
	final public String _value; 
	 
	public ExpressionPointConstraint(String table, String col, String val ) {
		this._table = table;
		_column = col;
		_value = val;
	...
	{
		return _table + ":" + _column + "=" + _value;
	}
	@Override
	public <T> LFuture<T> accept(AbstractVisitor visitor) {
		return new LFuture(visitor.visitPointConstraint(this)); 
	} 
