...
public class Block2MCache extends BlockCacheLazyAllocate{  
	
	 
	public static Block2MCache getInstance(DBFSProperties dbfs_prop_instance  ) 
	{
		return new Block2MCache(dbfs_prop_instance); 
	} 
	
    protected Block2MCache(DBFSProperties dbfs_prop_instance )
    {     			 
    	super( BlockSizes.block_2M,
    			Math.max( dbfs_prop_instance.mem_cache_size / BlockSizes.block_2M.getSize() ,
