...
public class LFS64B extends LFSManifold{ 
	static String _suggested_middle_name = ".64b";
	public LFS64B(String _root_path, 
			String _table_name, 
			String _mode, 
			int bufbitlen, 
			boolean native_mode,
		...
		super(_root_path, _table_name+_suggested_middle_name, 
				_mode, bufbitlen, 
				BlockSizes.block_64b, Block64BCache.getInstance(_dbfs_prop_instance), 
				native_mode,
				_dbfs_prop_instance); 
