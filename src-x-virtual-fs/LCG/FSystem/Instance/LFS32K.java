...
public class LFS32K extends LFSManifold{ 
	static String _suggested_middle_name = ".32k";
	public LFS32K(String _root_path, 
			String _table_name, 
			String _mode, 
			int bufbitlen, 
			boolean native_mode,
		...
		super(_root_path, _table_name+_suggested_middle_name, 
				_mode, bufbitlen, 
				BlockSizes.block_32k, Block32KCache.getInstance(_dbfs_prop_instance),
				native_mode,
				_dbfs_prop_instance); 
	} 
} 
